...
class CalculatorStub(object):
    """Calculator.SquareRoot() is  for function  suqare_root()
    """
    ...
    def __init__(self, channel):
        ...
        self.Calculator = channel.unary_unary(
                '/Calculator/Calculator',
                request_serializer=calculator__pb2.MyCalc.Request.SerializeToString,
                response_deserializer=calculator__pb2.MyCalc.Response.FromString,
                )
...
def add_CalculatorServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Calculator': grpc.unary_unary_rpc_method_handler(
                    servicer.Calculator,
                    request_deserializer=calculator__pb2.MyCalc.Request.FromString,
                    response_serializer=calculator__pb2.MyCalc.Response.SerializeToString,
            ),
    }
...
class Calculator(object):
    ...
    def Calculator(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Calculator/Calculator',
            calculator__pb2.MyCalc.Request.SerializeToString,
            calculator__pb2.MyCalc.Response.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
